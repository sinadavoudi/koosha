  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-zca-elements-item-contentDefault hover:text-zca-elements-item-contentActive hover:bg-zca-elements-item-backgroundActive':
          !selected,
        'bg-zca-elements-item-backgroundAccent text-zca-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-zca-elements-item-backgroundActive text-zca-elements-item-contentDefault': !selected,
        'bg-zca-elements-item-backgroundAccent text-zca-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-zca-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
